...
mod pod_validator {
    ...
    impl Validator {
        ...
        fn add_ceremony_hashes(&mut self, ceremony_id: u32, new_hashes: Vec<File>) -> Result<()> {
            ...
            let ceremony_hashes = self.ceremony_hashes.get(&ceremony_id).unwrap_or_else(|| Vec::new());
        ...
        pub fn get_ceremony_hashes_count(&self, ceremony_id: u32) -> Result<u32> {
            let hashes = self.ceremony_hashes.get(&ceremony_id).unwrap_or_else(|| Vec::new());
        ...
        pub fn get_ceremony(&self, ceremony_id: u32) -> Result<(Ceremony, Vec<File>, Vec<Metadata>), Error> {
            ...
            let metadatas = self.ceremony_metadatas.get(&ceremony_id).unwrap_or_else(|| Vec::new());
        ...
        fn add_ceremony_metadatas(&mut self, ceremony_id: u32, metadatas: Vec<Metadata>) -> Result<()> {
            ...
            let ceremony_metadatas = self.ceremony_metadatas.get(&ceremony_id).unwrap_or_else(|| Vec::new());
