...
const sgxEnabled = process.env.SGX_ENABLED === "false";

const VALIDATOR_CONTRACT_ADDRESS =
  "0x69520d3e5591fc688c9c14fd8100cc81a954618ece98759f7ee85b3dc66fe5aa";
...
async function main(args?: string[]) {
  ...
  const VALIDATOR_ABI =
    '{"contract":{"authors":["Kevin Wang <wy721@qq.com>"],"name":"pod_validator","version":"0.1.0"},"source":{"build_info":{"build_mode":"Release","cargo_contract_version":"3.2.0","rust_toolchain":"stable-x86_64-unknown-linux-gnu","wasm_opt_settings":{"keep_debug_symbols":false,"optimization_passes":"Z"}},"compiler":"rustc 1.72.1","hash":"0x2cd786627376fcaed9321ff2110096b66ca06f8f3ee2d05ec2ebe4d157fb6607","language":"ink! 4.2.0"},"spec":{"constructors":[{"args":[],"default":false,"docs":[],"label":"default","payable":false,"returnType":{"displayName":["ink_primitives","ConstructorResult"],"type":16},"selector":"0xed4b9d1b"}],"docs":[],"environment":{"accountId":{"displayName":["AccountId"],"type":0},"balance":{"displayName":["Balance"],"type":38},"blockNumber":{"displayName":["BlockNumber"],"type":6},"chainExtension":{"displayName":["ChainExtension"],"type":41},"hash":{"displayName":["Hash"],"type":39},"maxEventTopics":4,"timestamp":{"displayName":["Timestamp"],"type":40}},"events":[{"args":[{"docs":[],"indexed":false,"label":"mr_enclave","type":{"displayName":[],"type":1}}],"docs":["A new pod mr_enclave is added."],"label":"PodAdded"},{"args":[{"docs":[],"indexed":false,"label":"ceremony_id","type":{"displayName":["u32"],"type":6}},{"docs":[],"indexed":false,"label":"phase","type":{"displayName":["u32"],"type":6}},{"docs":[],"indexed":false,"label":"power","type":{"displayName":["u32"],"type":6}},{"docs":[],"indexed":false,"label":"bash","type":{"displayName":["u32"],"type":6}}],"docs":[],"label":"CeremonyAdded"},{"args":[{"docs":[],"indexed":false,"label":"ceremony_id","type":{"displayName":["u32"],"type":6}},{"docs":[],"indexed":false,"label":"name","type":{"displayName":["String"],"type":9}},{"docs":[],"indexed":false,"label":"value","type":{"displayName":["String"],"type":9}}],"docs":[],"label":"MetadataAdded"}],"lang_error":{"displayName":["ink","LangError"],"type":18},"messages":[{"args":[],"default":false,"docs":[" Returns the public key."],"label":"public_key","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":19},"selector":"0x52061d7d"},{"args":[{"label":"pod","type":{"displayName":[],"type":1}}],"default":false,"docs":[],"label":"allow","mutates":true,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":21},"selector":"0xaef3befe"},{"args":[{"label":"report","type":{"displayName":["SignedReport"],"type":24}}],"default":false,"docs":[" Validates the given RA report and signs the inner user_report_data."],"label":"sign","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":25},"selector":"0x81ca8fa1"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}},{"label":"hash","type":{"displayName":["String"],"type":9}},{"label":"name","type":{"displayName":["String"],"type":9}},{"label":"timestamp","type":{"displayName":["u32"],"type":6}}],"default":false,"docs":[],"label":"add_ceremony_hash","mutates":true,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":21},"selector":"0x5f4baa34"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}},{"label":"ipfs_hash","type":{"displayName":["String"],"type":9}}],"default":false,"docs":[],"label":"is_last_hash","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":27},"selector":"0xd3d7b2d4"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}}],"default":false,"docs":[],"label":"get_ceremony_hashes","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":30},"selector":"0xb12eab37"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}}],"default":false,"docs":[],"label":"get_ceremony_hashes_count","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":32},"selector":"0x002d1e5f"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}},{"label":"phase","type":{"displayName":["u32"],"type":6}},{"label":"power","type":{"displayName":["u32"],"type":6}},{"label":"bash","type":{"displayName":["u32"],"type":6}}],"default":false,"docs":[],"label":"new_ceremony","mutates":true,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":21},"selector":"0x489150a1"},{"args":[],"default":false,"docs":[],"label":"get_cerimonies","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":34},"selector":"0xd101eea9"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}},{"label":"name","type":{"displayName":["String"],"type":9}},{"label":"value","type":{"displayName":["String"],"type":9}}],"default":false,"docs":[],"label":"add_ceremony_metadata","mutates":true,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":21},"selector":"0x79f0e58a"},{"args":[{"label":"ceremony_id","type":{"displayName":["u32"],"type":6}}],"default":false,"docs":[],"label":"get_ceremony_metadata","mutates":false,"payable":false,"returnType":{"displayName":["ink","MessageResult"],"type":36},"selector":"0x9ec8a573"}]},"storage":{"root":{"layout":{"struct":{"fields":[{"layout":{"leaf":{"key":"0x00000000","ty":0}},"name":"owner"},{"layout":{"leaf":{"key":"0x00000000","ty":3}},"name":"allowlist"},{"layout":{"leaf":{"key":"0x00000000","ty":4}},"name":"ceremony_hashes"},{"layout":{"leaf":{"key":"0x00000000","ty":10}},"name":"ceremony_metadatas"},{"layout":{"leaf":{"key":"0x00000000","ty":14}},"name":"ceremonies"}],"name":"Validator"}},"root_key":"0x00000000"}},"types":[{"id":0,"type":{"def":{"composite":{"fields":[{"type":1,"typeName":"[u8; 32]"}]}},"path":["ink_primitives","types","AccountId"]}},{"id":1,"type":{"def":{"array":{"len":32,"type":2}}}},{"id":2,"type":{"def":{"primitive":"u8"}}},{"id":3,"type":{"def":{"sequence":{"type":1}}}},{"id":4,"type":{"def":{"sequence":{"type":5}}}},{"id":5,"type":{"def":{"tuple":[6,7]}}},{"id":6,"type":{"def":{"primitive":"u32"}}},{"id":7,"type":{"def":{"sequence":{"type":8}}}},{"id":8,"type":{"def":{"composite":{"fields":[{"name":"hash","type":9,"typeName":"String"},{"name":"name","type":9,"typeName":"String"},{"name":"timestamp","type":6,"typeName":"u32"}]}},"path":["pod_validator","pod_validator","File"]}},{"id":9,"type":{"def":{"primitive":"str"}}},{"id":10,"type":{"def":{"sequence":{"type":11}}}},{"id":11,"type":{"def":{"tuple":[6,12]}}},{"id":12,"type":{"def":{"sequence":{"type":13}}}},{"id":13,"type":{"def":{"composite":{"fields":[{"name":"name","type":9,"typeName":"String"},{"name":"value","type":9,"typeName":"String"}]}},"path":["pod_validator","pod_validator","Metadata"]}},{"id":14,"type":{"def":{"sequence":{"type":15}}}},{"id":15,"type":{"def":{"composite":{"fields":[{"name":"ceremony_id","type":6,"typeName":"u32"},{"name":"phase","type":6,"typeName":"u32"},{"name":"power","type":6,"typeName":"u32"},{"name":"bash","type":6,"typeName":"u32"}]}},"path":["pod_validator","pod_validator","Ceremony"]}},{"id":16,"type":{"def":{"variant":{"variants":[{"fields":[{"type":17}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":17},{"name":"E","type":18}],"path":["Result"]}},{"id":17,"type":{"def":{"tuple":[]}}},{"id":18,"type":{"def":{"variant":{"variants":[{"index":1,"name":"CouldNotReadInput"}]}},"path":["ink_primitives","LangError"]}},{"id":19,"type":{"def":{"variant":{"variants":[{"fields":[{"type":20}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":20},{"name":"E","type":18}],"path":["Result"]}},{"id":20,"type":{"def":{"sequence":{"type":2}}}},{"id":21,"type":{"def":{"variant":{"variants":[{"fields":[{"type":22}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":22},{"name":"E","type":18}],"path":["Result"]}},{"id":22,"type":{"def":{"variant":{"variants":[{"fields":[{"type":17}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":17},{"name":"E","type":23}],"path":["Result"]}},{"id":23,"type":{"def":{"variant":{"variants":[{"index":0,"name":"BadOrigin"},{"index":1,"name":"InvalidReport"},{"index":2,"name":"PodNotAllowed"},{"index":3,"name":"CeremonyNotFound"}]}},"path":["pod_validator","pod_validator","Error"]}},{"id":24,"type":{"def":{"composite":{"fields":[{"name":"report","type":9,"typeName":"String"},{"name":"signature","type":9,"typeName":"String"},{"name":"certificate","type":9,"typeName":"String"}]}},"path":["pod_validator","pod_validator","SignedReport"]}},{"id":25,"type":{"def":{"variant":{"variants":[{"fields":[{"type":26}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":26},{"name":"E","type":18}],"path":["Result"]}},{"id":26,"type":{"def":{"variant":{"variants":[{"fields":[{"type":20}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":20},{"name":"E","type":23}],"path":["Result"]}},{"id":27,"type":{"def":{"variant":{"variants":[{"fields":[{"type":28}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":28},{"name":"E","type":18}],"path":["Result"]}},{"id":28,"type":{"def":{"variant":{"variants":[{"fields":[{"type":29}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":29},{"name":"E","type":23}],"path":["Result"]}},{"id":29,"type":{"def":{"primitive":"bool"}}},{"id":30,"type":{"def":{"variant":{"variants":[{"fields":[{"type":31}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":31},{"name":"E","type":18}],"path":["Result"]}},{"id":31,"type":{"def":{"variant":{"variants":[{"fields":[{"type":7}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":7},{"name":"E","type":23}],"path":["Result"]}},{"id":32,"type":{"def":{"variant":{"variants":[{"fields":[{"type":33}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":33},{"name":"E","type":18}],"path":["Result"]}},{"id":33,"type":{"def":{"variant":{"variants":[{"fields":[{"type":6}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":6},{"name":"E","type":23}],"path":["Result"]}},{"id":34,"type":{"def":{"variant":{"variants":[{"fields":[{"type":35}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":35},{"name":"E","type":18}],"path":["Result"]}},{"id":35,"type":{"def":{"variant":{"variants":[{"fields":[{"type":14}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":14},{"name":"E","type":23}],"path":["Result"]}},{"id":36,"type":{"def":{"variant":{"variants":[{"fields":[{"type":37}],"index":0,"name":"Ok"},{"fields":[{"type":18}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":37},{"name":"E","type":18}],"path":["Result"]}},{"id":37,"type":{"def":{"variant":{"variants":[{"fields":[{"type":12}],"index":0,"name":"Ok"},{"fields":[{"type":23}],"index":1,"name":"Err"}]}},"params":[{"name":"T","type":12},{"name":"E","type":23}],"path":["Result"]}},{"id":38,"type":{"def":{"primitive":"u128"}}},{"id":39,"type":{"def":{"composite":{"fields":[{"type":1,"typeName":"[u8; 32]"}]}},"path":["ink_primitives","types","Hash"]}},{"id":40,"type":{"def":{"primitive":"u64"}}},{"id":41,"type":{"def":{"variant":{}},"path":["ink_env","types","NoChainExtension"]}}],"version":"4"}';
...
async function handleOutputFiles(
  ...
  if (outputFileNames != null) {
    ...
    for (let i = 0; i < outputFileNames.length; i++) {
      ...
      console.log(`[Phala] Adding output file hash to contract...`);

      console.log(
        "[Phala] Calling method addCeremonyHash with args:",
        ceremonyId,
        ipfsHash,
        outputFileName,
        timestamp
      ...
      const result = await contract.send.addCeremonyHash(
        { pair, cert, address: cert.address },
        ceremonyId,
        ipfsHash,
        outputFileName,
